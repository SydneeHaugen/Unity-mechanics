...
public class DrawSquare : MonoBehaviour
{
    ...
    public float destroyDelay = 3f; // Set the time delay in seconds before the square disappears.
    ...
    void CreatePlatform()
    {
        ...
        StartCoroutine(DestroyPlatform(currentPlatform)); // Start the coroutine to destroy the square.
    }
    ...
    IEnumerator DestroyPlatform(GameObject platform) // Coroutine to destroy the square after a few seconds.
    {
